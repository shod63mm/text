            ...
            <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
              <div class="p-4 sm:p-7">
                <div class="text-center">
                  ...
                  <h1 class="mt-4 text-center text-3xl font-bold text-blue-700">Добавить клиент</h1>
                </div>
                ...
                <div class="mt-5">
                  ...
                  <!-- Form -->
                  <form action="{{ route('userregister') }}" method="POST" class="mt-5">
                    @csrf
                    <div class="grid gap-y-4">
                      ...
                      <!-- Form Group -->
                      <div>
                        <label for="phone" class="block text-sm mb-1 dark:text-white">Телефон</label>
                        <div class="relative">
                      ...
                      <!-- Form Group -->
                      <div>
                        <label for="adress" class="block text-sm mb-1 dark:text-white">Адрес</label>
                        <div class="relative">
                  ...
                  <div class="w-full mt-2 text-center">
                    <a href="{{ route('klientlist') }}" class="text-blue-700"> Список клиентов</a>
                  </div>
                </div>
              </div>
            </div>
