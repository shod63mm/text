            ...
            <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
              <div class="p-4 sm:p-7">
                <div class="text-center">
                  ...
                  <h1 class="mt-4 text-center text-3xl font-bold text-blue-700">Добавит работник</h1>
                </div>
                ...
                <div class="mt-5">
                  ...
                  <form action="{{ route('register') }}" method="POST" class="mt-5">
                    ...
                    <div class="grid gap-y-4">
                      <!-- Form Group -->
                      <div>
                        <label for="name" class="block text-sm mb-1 dark:text-white">Имя</label>
                        <div class="relative">
                      ...
                      <!-- Form Group -->
                        <div class="">
                            <label for="rolle" class="block text-sm mb-1 dark:text-white">Роль</label>
                            <div class="relative">
                                <select id="rolle" name="rolle" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required aria-describedby="rolle-error">
                                    <option value="" disabled selected>Вибирите рол</option>
                                    <option value="admin">Админ</option>
                                    <option value="driver">Шофёр</option>
                                    <option value="cleaner">Мойщик ковров</option>
                                </select>
                            </div>
                        </div>
                      ...
                      <!-- Form Group -->
                      <div>
                        <label for="password" class="block text-sm mb-1 dark:text-white">Пароль</label>
                        <div class="relative">
                      ...
                      <button class="mt-3 w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Регистрация</button>
                    </div>
                  </form>
                  <!-- End Form -->
                  <div class="w-full mt-2 text-center">
                    <a href="{{ route('userlist') }}" class="text-blue-700"> Список работники</a>
                  </div>
                </div>
              </div>
            </div>
